...
public class VueloFacade extends AbstractFacade<Vuelo> implements VueloFacadeLocal {
    ...
    @Override
    public ArrayList<ArrayList<Pair<Asiento, Integer>>> getSeatLists(Vuelo flight, String cabin) {
